import { Button, Card, FormLabel, Input, Select, MenuItem, FormControl, InputLabel } from "@mui/material";
...
function CarForm({ customerId }) {
    ...
    const handleUpdate = () => {
        fetch(`http://localhost:8080/api/customers/${formData.clientId}/cars/${formData.id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
