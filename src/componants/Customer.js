                          ...
                          {car.carServices.length > 0 ? (
                              <List>
                                {car.carServices.map((service, serviceIndex) => (
                                    <Card sx={{ marginBottom: 2 }} key={serviceIndex} className="service-card">
                                      <CardContent>
                                        <Typography>
                                          Date of Service: {new Date(service.dateOfService).toLocaleDateString()}
                                        </Typography>
                                        <Typography>
                                          Worker: {service.workerFirstName} {service.workerLastName}
                                        </Typography>
                                        <Typography>
                              ...
                              <Typography>No services available for this car</Typography>
                          )}
                        </div>
                      </li>
                    </Card>
